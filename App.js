...
class App extends Component {
  ...
  getNapitKannasta = () => {
    axios({ method: "get", url: "HTTP://localhost:3000/getData" }).then(res => {
      console.log(res);
      this.setState({ btnKokoelma: res.data });
  ...
  napitKantaan = () => {
    ...
    axios({
      ...
      .finally(this.setState({ asd: "asd" }));
  };

  nappienPoistoKannasta = () => {
    let data = {};
    data.poisto = document.getElementById("poisto").value;
    axios({
      method: "delete",
  ...
  render() {
    ...
    return (
      <div>
        ...
        {/* <h5 style={{ padding: "10px", marginTop: "20px" }}>
          Luo uusia painikkeita:
        </h5>
        <button onClick={this.toggleDiv}>Näytä / piilota</button> */}
            ...
            <div style={{ padding: "10px", marginTop: "20px" }}>
              ...
              <div>
                ...
                <button
                  ...
                  onClick={() => this.painikkeenPoisto(this.state.nimi)}
                >
                  Poista painike
                </button>
                <br />
...
// Buttonien tyylitykset
// show on/off lisäykselle

// local storage

// Käyttöliittymän ilmeen parantaminen. Apinoidaanko värit vanhasta?
